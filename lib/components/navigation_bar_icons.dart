...
class NavBarIcon extends StatelessWidget {
  ...
  final IconData inactiveIcon; //icon to be shown when active
  final String? label; //label (not required)
  final bool?
      labelOnActive; //to show (true) or not show label only when active (false)
  final bool darkMode; //to show label and icon in black (false) or white (true)
